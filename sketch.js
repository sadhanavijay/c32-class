...
var sadsd,cutsd,eatsd,airblowingsd,backgoundsd;
...
function preload()
{
  ...
  //load all sounds
  backgoundsd = loadSound("sound1.mp3");
 sadsd = loadSound("sad.wav");
 cutsd = loadSound("rope_cut.mp3");
 eatsd = loadSound("eating_sound.mp3");
 airblowingsd = loadSound("air.wav");
